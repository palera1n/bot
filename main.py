...
from utils import cfg, db, logger, CosmoContext, BanCache, IssueCache, Tasks, RuleCache, init_client_session, scam_cache
...
async def main():
    async with bot:
        await bot.start(os.environ.get("COSMO_TOKEN"), reconnect=True)
