...
from utils import CosmoContext


class Menu(ui.View):
    def __init__(self, ctx: CosmoContext, entries: list, per_page: int, page_formatter: Callable[[CosmoContext, list, int, list], None], whisper: bool, show_skip_buttons: bool = True, start_page=1, timeout_function=None):
        super().__init__(timeout=60)

        self.ctx = ctx
        self.is_interaction = isinstance(ctx, CosmoContext)
