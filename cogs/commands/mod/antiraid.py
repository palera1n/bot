...
class AntiRaid(commands.Cog):
    ...
    @transform_context
    async def raid(self, ctx: CosmoContext, phrase: str) -> None:
    ...
    @transform_context
    async def batchraid(self, ctx: CosmoContext) -> None:
    ...
    @transform_context
    async def removeraid(self, ctx: CosmoContext, phrase: str) -> None:
        word = phrase.lower()
    ...
    @transform_context
    async def spammode(self, ctx: CosmoContext, mode: bool = None) -> None:
        if mode is None:
    ...
    @transform_context
    async def verify(self, ctx: CosmoContext, user: discord.Member, mode: bool = None) -> None:
    ...
    @transform_context
    async def lock(self, ctx: CosmoContext, channel: discord.TextChannel = None):
    ...
    @transform_context
    async def unlock(self,  ctx: CosmoContext, channel: discord.TextChannel = None):
        if channel is None:
            channel = ctx.channel
    ...
    @transform_context
    async def freezeable(self,  ctx: CosmoContext, channel: discord.TextChannel = None):
    ...
    @transform_context
    async def unfreezeable(self,  ctx: CosmoContext, channel: discord.TextChannel = None):
        channel = channel or ctx.channel
    ...
    async def lock_unlock_channel(self,  ctx: CosmoContext, channel, lock=None):
