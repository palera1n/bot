...
from utils.framework import (MessageTextBucket, gatekeeper,
                             genius_and_up, whisper, ImageAttachment)
...
class Tags(commands.Cog):
    ...
    @transform_context
    async def tag(self, ctx: CosmoContext, name: str, user_to_mention: discord.Member = None):
        name = name.lower()
    ...
    @transform_context
    @whisper
    async def taglist(self, ctx: CosmoContext):
