...
class UserInfo(commands.Cog):
    ...
    @transform_context
    @whisper
    async def userinfo(self, ctx: CosmoContext, user: Union[discord.Member, discord.User] = None) -> None:
    ...
    @transform_context
    @whisper
    async def xp(self, ctx: CosmoContext, member: discord.Member = None) -> None:
        if member is None:
            member = ctx.author
    ...
    @transform_context
    @whisper
    async def warnpoints(self, ctx: CosmoContext, member: discord.Member = None):
    ...
    @transform_context
    @whisper
    async def xptop(self, ctx: CosmoContext):
    ...
    @transform_context
    @whisper
    async def cases(self, ctx: CosmoContext, user: Union[discord.Member, discord.User] = None):
...
async def handle_userinfo(ctx: CosmoContext, user: Union[discord.Member, discord.User]):
