...
from utils import CosmoContext, cfg, transform_context, format_number
...
class Stats(commands.Cog):
    ...
    @transform_context
    @whisper
    async def ping(self, ctx: CosmoContext) -> None:
        embed = discord.Embed(
    ...
    @transform_context
    @whisper
    async def roleinfo(self, ctx: CosmoContext, role: discord.Role) -> None:
    ...
    @transform_context
    @whisper
    async def stats(self, ctx: CosmoContext) -> None:
    ...
    @transform_context
    @whisper
    async def serverinfo(self, ctx: CosmoContext):
        guild = ctx.guild
    ...
    @transform_context
    @whisper
    async def raidstats(self, ctx: CosmoContext) -> None:
    ...
    @transform_context
    @whisper
    async def mod(self, ctx: CosmoContext, mod: discord.Member = None, keyword: str = None) -> None:
        if mod is None:
            mod = ctx.author
    ...
    @transform_context
    @whisper
    async def keyword(self, ctx: CosmoContext, keyword: str) -> None:
        embed = discord.Embed(color=discord.Color.blurple())
