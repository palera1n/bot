...
class Genius(commands.Cog):
    ...
    async def on_thread_create(self, thread: discord.Thread):
        ...
        if not existing_threads_by_author:
            ...
            new_embed.set_footer(text="palera1n AI support is in beta and this message was generated automatically. Please disregard if incorrect. Not every answer is perfect or correct.")
